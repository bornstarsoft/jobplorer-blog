...
targetAudience:
  - "Game developer job seekers"
  - "Students researching game development and game design roles"
  - "Career changers comparing game industry job search channels"
jobSearchStartingPoints:
  - "General job sites"
  - "Company and studio career pages"
  - "Professional networking platforms"
  - "Official occupation research resources"
  - "Game development community resources"
...
portfolioOrResumeNotes:
  - "Portfolio, demo, and resume expectations can vary by studio, employer, and role."
  - "Users should verify current requirements from employer career pages and official job postings."
officialSourcesToCheck:
  - "BLS Occupational Outlook Handbook pages for related software development occupations"
  - "O*NET pages for Video Game Designers and related software development occupations"
  - "Employer and studio career pages"
  - "Official job site help pages"
  - "Education or training provider pages, when relevant"
usefulFor:
  - "Job seekers researching where to start"
  - "People comparing job search channels for game development and game design roles"
limitations:
  - "This guide does not provide hiring, salary, legal, visa, labor, tax, certification, or career outcome advice or guarantees."
